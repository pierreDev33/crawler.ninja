...
describe('MultiCore', function() {
        ...
        */
        ...
        it.only('Audit a mini site - crawl only a.href links ', function(done) {

            this.timeout(3000);
            var c = new crawler.Crawler({multiCores: true, images : false, links: false /*links = html link tag*/, scripts:false });
            var audit = new seoaudit.Plugin(c);
            //var log = new logger.Plugin(c);
