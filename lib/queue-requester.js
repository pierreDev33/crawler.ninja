 ...
 *
 * @param the default config to use to make the requests.
 *
 */
...
Requester.prototype.queue = function (options) {
    ...
    // Add the default options that are not in the current request options
    options = _.extend(options, _.omit(this.options, _.keys(options)));
    this.q.push(options);
